...
function getRoomByDinosaurName(dinosaurs, rooms, dinosaurName) {
  //filter through dino array and save the dino objects with the given name. else error
  dinosaurs.filter(function(dino){
    return dino.name === dino.dinosaurName
  })
  //filter through room array and save the room objects with the same dino ID as the saved objects
  }
  console.log(getRoomByDinosaurName(dinosaurs, rooms, dinosaurName))
